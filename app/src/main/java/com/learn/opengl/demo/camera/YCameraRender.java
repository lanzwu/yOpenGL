package com.learn.opengl.demo.camera;
...
import com.learn.opengl.demo.camera.YCameraFboRender;
...
public class YCameraRender implements YGLSurfaceView.YGLRender {
    ...
    public void onSurfaceCreated() {
        ...
        //FBO 当我们需要对纹理进行多次渲染采样时，而这些渲染采样是不需要展示给用户看的，
        // 我们就可以用一个单独的缓冲对象（离屏渲染）来存储我们的这几次渲染采样的结果，等处理完后才显示到窗口上。
        int[] fbo = new int[1];
